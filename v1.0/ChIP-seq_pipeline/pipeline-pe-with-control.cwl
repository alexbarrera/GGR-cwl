#!/usr/bin/env cwl-runner
 class: Workflow
 cwlVersion: v1.0
 doc: "ChIP-seq pipeline - reads: PE, samples: treatment and control."
 requirements:
 ...
 outputs:
    ...
    trimm_control_raw_counts_read1:
      doc: Raw read counts for R1 of fastq files after trimming for control
      type: File[]
      outputSource: trimm_control/output_trimmed_read2_fastq_read_count
    trimm_control_raw_counts_read2:
      doc: Raw read counts for R2 of fastq files after trimming for control
      type: File[]
      outputSource: trimm_control/output_trimmed_read2_fastq_read_count
